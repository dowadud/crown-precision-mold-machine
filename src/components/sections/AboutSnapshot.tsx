        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            <div className="grid grid-cols-2 gap-px bg-white/[0.04]">
              {stats.map((stat, i) => (
                <div key={stat.label} className="bg-[#0B0B0D] p-8 relative group hover:bg-charcoal/50 transition-colors duration-300">
            ...
            {/* Visual accent block */}
            <FadeIn delay={0.3}>
              <div className="mt-px bg-charcoal/60 border border-white/[0.04] p-6">
                ...
                <p className="text-steel/70 text-sm leading-relaxed italic text-center">
                  &ldquo;To provide tire manufacturers with precision mold services
                  that reduce costs, extend production readiness, and support
                  long-term operational excellence.&rdquo;
                </p>
              </div>
            </FadeIn>
          </div>
